...
INSERT INTO "auth"."users" ("instance_id", "id", "aud", "role", "email", "encrypted_password", "email_confirmed_at", "invited_at", "confirmation_token", "confirmation_sent_at", "recovery_token", "recovery_sent_at", "email_change_token_new", "email_change", "email_change_sent_at", "last_sign_in_at", "raw_app_meta_data", "raw_user_meta_data", "is_super_admin", "created_at", "updated_at", "phone", "phone_confirmed_at", "phone_change", "phone_change_token", "phone_change_sent_at", "email_change_token_current", "email_change_confirm_status", "banned_until", "reauthentication_token", "reauthentication_sent_at", "is_sso_user", "deleted_at", "is_anonymous") VALUES
	...
	('00000000-0000-0000-0000-000000000000', 'c8e84cfc-ead4-45d2-a7f5-1f084125fd2b', 'authenticated', 'authenticated', 'noreply@aloshy.ai', NULL, '2025-01-15 11:50:21.071909+00', NULL, '', NULL, '', NULL, '', '', NULL, '2025-01-15 11:50:21.363634+00', '{"provider": "github", "providers": ["github"]}', '{"iss": "https://api.github.com", "sub": "88331242", "name": "aloshy.🅰🅸", "email": "noreply@aloshy.ai", "full_name": "aloshy.🅰🅸", "user_name": "aloshy-ai", "avatar_url": "https://avatars.githubusercontent.com/u/88331242?v=4", "provider_id": "88331242", "email_verified": true, "phone_verified": false, "preferred_username": "aloshy-ai"}', NULL, '2025-01-15 11:50:21.061414+00', '2025-01-15 14:52:39.189724+00', NULL, NULL, '', '', NULL, '', 0, NULL, '', NULL, false, NULL, false);
...
INSERT INTO "auth"."identities" ("provider_id", "user_id", "identity_data", "provider", "last_sign_in_at", "created_at", "updated_at", "id") VALUES
	('88331242', 'c8e84cfc-ead4-45d2-a7f5-1f084125fd2b', '{"iss": "https://api.github.com", "sub": "88331242", "name": "aloshy.🅰🅸", "email": "noreply@aloshy.ai", "full_name": "aloshy.🅰🅸", "user_name": "aloshy-ai", "avatar_url": "https://avatars.githubusercontent.com/u/88331242?v=4", "provider_id": "88331242", "email_verified": true, "phone_verified": false, "preferred_username": "aloshy-ai"}', 'github', '2025-01-15 11:50:21.067617+00', '2025-01-15 11:50:21.067675+00', '2025-01-15 11:50:21.067675+00', '30ac2a6d-2f80-4010-8c2a-04e57e0c440a'),
...
INSERT INTO "auth"."sessions" ("id", "user_id", "created_at", "updated_at", "factor_id", "aal", "not_after", "refreshed_at", "user_agent", "ip", "tag") VALUES
	...
	('d0951742-04c6-478d-a56e-a32581d0acc8', 'c8e84cfc-ead4-45d2-a7f5-1f084125fd2b', '2025-01-15 11:50:21.363689+00', '2025-01-15 14:52:39.190764+00', NULL, 'aal1', NULL, '2025-01-15 14:52:39.190711', 'Next.js Middleware', '172.21.0.1', NULL);
...
INSERT INTO "auth"."refresh_tokens" ("instance_id", "id", "token", "user_id", "revoked", "created_at", "updated_at", "parent", "session_id") VALUES
	...
	('00000000-0000-0000-0000-000000000000', 5, 'vbvLv1EdG23nNhNPEMfDvg', 'c8e84cfc-ead4-45d2-a7f5-1f084125fd2b', false, '2025-01-15 14:52:39.188879+00', '2025-01-15 14:52:39.188879+00', 's-xGUqqWN6lnuyAMWkeWDA', 'd0951742-04c6-478d-a56e-a32581d0acc8');
...
INSERT INTO "public"."workflows" ("created_at", "workflow", "enabled", "trigger", "description", "name", "user_id", "id") VALUES
	('2024-09-14 15:46:53.822922+00', '{"edges": [{"to": "1", "from": "$source"}], "actions": [{"id": "1", "kind": "generate_linkedin_posts", "name": "Generate LinkedIn posts"}]}', true, 'blog-post.updated', 'Getting a review from AI', 'When a blog post is moved to review', 'c8e84cfc-ead4-45d2-a7f5-1f084125fd2b', '746d6b46-c206-4231-a798-5e39775845fa'),
	('2024-09-14 20:19:41.892865+00', '{"edges": [{"to": "1", "from": "$source"}], "actions": [{"id": "1", "kind": "generate_tweet_posts", "name": "Generate Twitter posts"}]}', true, 'blog-post.published', 'Actions performed to optimize the distribution of blog posts', 'When a blog post is published', 'ee136acd-31f0-4e8c-ae1d-7bb9bd1f5c17', 'ee24d1e0-7f07-4c0c-8ff5-e56a9300e04f');
