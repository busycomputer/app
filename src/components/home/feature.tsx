...
export default function Feature() {
  return (
    <Bounded className="px-7 pt-32">
      <p className="font-sans-plex w-fit pt-2 text-base text-primary md:mx-auto">FEATURES</p>
      <h1 className="font-space mb-10 mt-1 w-fit text-4xl md:mx-auto md:text-4xl lg:mb-16 lg:mt-5 text-mutedText">
