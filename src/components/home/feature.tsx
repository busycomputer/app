      ...
      <div className="">
        <div className="flex h-[340px] ">
          <div className="flex flex-col border">
            ...
            <div className="flex h-full items-center pl-14">CUSTOMIZABLE DRAG COMPONENT</div>
          </div>
          <div className="flex flex-col border">
            <Image src={workFlow2} alt="" className="" />
            <div className="flex h-full items-center pl-14">WORKFLOW MARKETPLACE</div>
          </div>
        </div>
        <div className="flex h-[340px] border">
          <div className="flex flex-col border">
            <Image src={workFlow3} alt="" className="" />
            <div className="flex h-full items-center pl-14">PROMPT TO GENERATE</div>
