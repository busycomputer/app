...
export default function HeroDescription() {
  return (
    <div className="mx-auto flex lg:h-72 max-w-screen-xl flex-col items-center justify-between ">
      ...
      <div className="flex w-full max-w-[884px] flex-col items-center gap-4 ">
        <div className="font-space text-center text-3xl sm:text-3xl md:text-2xl lg:text-6xl">BUILD AMAZING WORKFLOW AT WARPSEED</div>
        <div className="font-sans-plex w-full max-w-[630px] text-muted-foreground text-sm lg:text-base">
