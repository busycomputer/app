...
export default function HeroDescription() {
  return (
    <div className="mx-auto flex sm:h-60 max-w-screen-xl flex-col items-center  lg:h-72">
      <div className="font-space-mono mx-3 mb-3 flex max-w-96 shrink-0 items-center gap-3 overflow-hidden border-2 bg-[#070708] px-1 py-1 text-xs font-light text-muted-foreground sm:px-2 sm:py-2 md:text-sm lg:font-normal">
      ...
      <div className="flex w-full max-w-xl flex-col items-center gap-4  md:max-w-3xl lg:max-w-[884px]">
        ...
        <div className="font-sans-plex w-full max-w-[630px] text-center text-xs text-muted-foreground md:text-sm lg:text-[16px] lg:leading-[1.5]">
